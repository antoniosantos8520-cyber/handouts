...
Reading copies and player-facing handouts for my tabletop RPG projects, hosted with GitHub Pages.
Every link below is shareable as-is — no login, nothing to install.

## The Black Eye of the Goblin King — a *Dragonslayer* adventure
- **[The adventure](https://antoniosantos8520-cyber.github.io/handouts/black-eye-of-the-goblin-king.html)** — the full frontier adventure (goblin raids, a dying chieftain, a wounded unicorn), with all eleven Foundry scene maps embedded.
- **[Player primer](https://antoniosantos8520-cyber.github.io/handouts/black-eye-primer.html)** — a spoiler-safe handout to give players before the game.
